...
test('HTTP endpoints return OpenAPI-compliant JSON payloads (vertical slice)', async () => {
  ...
  try {
    ...
    const cases = [
      ...
      {
        name: 'GET /api/performers/{id}/feed',
        openapiPath: '/api/performers/{id}/feed',
        method: 'get',
        url: `${baseUrl}/api/performers/${MEMORY_IDS.performer}/feed?limit=5`,
        headers: {},
        expectedStatus: 200,
      },
      {
        name: 'GET /api/performers/{id}/requests',
        openapiPath: '/api/performers/{id}/requests',
        method: 'get',
        url: `${baseUrl}/api/performers/${MEMORY_IDS.performer}/requests`,
        headers: {},
        expectedStatus: 200,
      },
      {
      ...
      {
        name: 'GET /api/me/achievements',
        openapiPath: '/api/me/achievements',
        method: 'get',
        url: `${baseUrl}/api/me/achievements`,
        headers: authHeaders,
        expectedStatus: 200,
      },
      {
      ...
      },
      {
        ...
        openapiPath: '/api/chat/conversations',
        method: 'get',
        url: `${baseUrl}/api/chat/conversations?limit=10`,
        headers: authHeaders,
        expectedStatus: 200,
      },
      {
        name: 'GET /api/chat/{userId}',
        openapiPath: '/api/chat/{userId}',
        method: 'get',
        url: `${baseUrl}/api/chat/${MEMORY_IDS.performer}?limit=10`,
        headers: authHeaders,
        expectedStatus: 200,
      },
      {
        name: 'POST /api/chat/send',
        openapiPath: '/api/chat/send',
        method: 'post',
        url: `${baseUrl}/api/chat/send`,
        headers: { ...authHeaders, 'content-type': 'application/json' },
        body: { recipient_id: MEMORY_IDS.performer, message: 'Put me on the leaderboard.' },
        expectedStatus: 201,
      },
      {
